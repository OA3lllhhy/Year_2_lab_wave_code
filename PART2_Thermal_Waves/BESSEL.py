...
# YOUR DATA:
# =============================================================================
trans_data = [0.147]#input your transmission data here
trans_periods = [240] #input the corresponding periods here (s)
phase_data = [3.1339]#input your phase lag data here
phase_periods = [240]#input the corresponding periods here (s)
r_out = 0.01032 #outer radius (m)
